...
public class AuthenticationController {
    ...
    public ResponseEntity<JSONObject> createAuthenticationToken(
        ...
        final String jwt = jwtTokenUtil.generateJWTAssertionFromString(authenticationRequest.getKeyPublic(),
                authenticationRequest.getKeyPrivate(), authenticationRequest.getoAuthBasePath(),
                authenticationRequest.getClientId(), authenticationRequest.getUserId());
        ...
        HttpResponse<String> response = Unirest.post(base_url_docusign + "/oauth/token")
                ...
                .queryString("assertion", jwt).queryString("grant_type", grant_type).asString();
    ...
    // public ResponseEntity<?> getAccessToken(@RequestParam("grant_type") String
    // grant_type
    ...
    // String base_url_docusign = env.getProperty("url.dev.docusign");
    //
    // HttpUrl.Builder urlBuilder = HttpUrl.parse(base_url_docusign +
    // "/oauth/token").newBuilder();
    ...
    //
    // @RequestMapping(value = "/oauth/token", method = RequestMethod.POST)
    // public JSONObject getAccessToken(@RequestParam("grant_type") String
    // grant_type
    // ,@RequestParam("assertion") String assertion
    // /*,@RequestParam("redirect_uri") String redirect_uri*/) throws Exception {
    //
    // String base_url_docusign = env.getProperty("url.dev.docusign");
    //
    // HttpResponse<String> response = Unirest.post(base_url_docusign +
    // "/oauth/token").
